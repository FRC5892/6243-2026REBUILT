...
/**
 * Full shooter subsystem logic: - AdvantageKit logging - Characterization hooks - Idle / firing /
 * closed-loop velocity control - Simulation support
 */
public class Shooter extends SubsystemBase {
  ...
  public boolean isAtSpeed(double targetRPM) {
    return Math.abs(inputs.mainVelocityRPM - targetRPM)
        < ShooterConstants.kVelocityTolerance.get(); // SPEED LIMIT
  }
