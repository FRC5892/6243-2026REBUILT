...
public final class ShooterConstants {
  ...
  public static final LoggedTunableNumber kIdleVoltage =
      new LoggedTunableNumber("Shooter/IdleVoltage", 4.9); // SPEED LIMIT
  public static final LoggedTunableNumber kFeederVoltage =
      new LoggedTunableNumber("Shooter/FeederVoltage", 8.0); // SPEED LIMIT
  public static final LoggedTunableNumber kFiringBoost =
      new LoggedTunableNumber("Shooter/FiringBoost", 1.0); // SPEED LIMIT

  // Velocity tolerance for "at speed" check
  public static final LoggedTunableNumber kVelocityTolerance =
      new LoggedTunableNumber("Shooter/VelocityTolerance", 50.0); // RPM
}
