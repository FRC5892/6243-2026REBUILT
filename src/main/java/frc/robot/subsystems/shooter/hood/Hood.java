...
public class Hood extends SubsystemBase {
  ...
  /**
   * A command that requests the robot to move to a robot-relative angle. The command completes
  ...
  /**
   * A command that commands the robot to move to a angle. This command ends when the setpoint is
   * archived
   *
   * @param angle a supplier of the target angle. The angle is relative to vertical. 0 is vertical,
   *     90 is horizontal
