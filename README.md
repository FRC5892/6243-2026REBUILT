...
## About (tbd) (2026)
(tbd) is our robot entry for the 2026 FRC competition, REBUILT. (tbd) features a swerve drivechain (a system allowing wheels to rotate and move in any direction), a dual shooter with a conjoined hood, an expandable hopper design with a roller floor, a slapdown intake, a split indexer, a vortex wheel feeder, L1 climbing capabilities, and can navigate both over the bump and under the trench.
